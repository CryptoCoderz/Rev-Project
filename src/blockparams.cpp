...
int64_t FRrateDWN = DSrateNRM - 45;
int64_t FRrateFLR = DSrateNRM - 75;
...
//
//
// Reward calculations for 13-years of REV emissions
// 21 Million Total     | 14,000,000 Premine (For Swap)
// 100% Remaining REV :  7,000,000 (Mineable)
// ----------------------------------
...
// Payout per block     : 5 REV
// Payout per day       : 5 * ((1 * 60 * 60) / (5 * 60) * 24)                   =       1,440 REV
// Payout per month     : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 30)            =      43,200 REV
// Payout per year      : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 365)           =     525,600 REV
// Mineout (13 Years)   : 5 * (13.32 * (((1 * 60 * 60) / (5 * 60) * 24) * 365))	=  21,000,000 REV
// ----------------------------------
// (Network Allocation) (BLOCKS | 13-Years of minting)
// Singular Payout      : 1.25 REV
// Maternode Payout     : 3.50 REV
// DevOps Payout        : 0.25 REV
// Total Payout (Block) : 5.00 REV
// ----------------------------------
// (PLEASE NOTE)
