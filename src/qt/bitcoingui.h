...
/**
  Rev GUI main class. This class represents the main window of the Rev UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RevGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit RevGUI(QWidget *parent = 0);
    ~RevGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a Rev  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
