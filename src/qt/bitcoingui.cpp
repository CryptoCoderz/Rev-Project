...
void RevGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none; } QToolButton:hover { background-color: rgb(217, 199, 113, 0.4); } QToolButton:checked { background-color: rgb(217, 199, 113, 0.4); } QToolButton:pressed { background-color: rgb(217, 199, 113, 0.4); } #tabs { color: #ffffff; background: none; border: none;}");
    toolbar->setIconSize(QSize(64,64));

    if(!fUseDarkTheme)
    {
        toolbar->setStyleSheet("QToolBar { background: none; } QToolButton { color: #ffffff; background: none;} QToolButton:hover { background-color: rgb(217, 199, 113, 0.4); } QToolButton:checked { background-color: rgb(217, 199, 113, 0.4); } QToolButton:pressed { background-color: rgb(217, 199, 113, 0.4); } #tabs { color: #ffffff; background: none; border: none;}");//QToolBar { background: none; }
    }
