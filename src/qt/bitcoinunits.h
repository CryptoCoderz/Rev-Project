...
/** Rev unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RevUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RevUnits(QObject *parent);
